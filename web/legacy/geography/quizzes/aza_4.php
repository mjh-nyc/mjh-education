	...
	$(document).ready(function() {
		$(MQS).ready(function() {
			...
			var qParams1Messages = new Array(
				...
				'Dachau was the first of the Nazi’s numerous concentration camps. It was established in March 1933.<br><br><a class="next-question" href="'+$legacyURL+'?name=aza&question=done">Next question</a>'
			);
			var qParams1 = {
				mqID: 1,
