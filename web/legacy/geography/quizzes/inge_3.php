	...
	$(document).ready(function() {
		$(MQS).ready(function() {
			...
			var qParams1Messages = new Array(
				...
				'In Auschwitz-Birkenau, 1.3 million people were killed, 90% of whom were Jews.<br><br><a class="next-question" href="'+$legacyURL+'?name=inge&question=4">Next question</a>'
			);
			var qParamsNextLink = '';
			var qParams1 = {
				mqID: 1,
