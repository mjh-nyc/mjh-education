	...
	$(document).ready(function() {
		$(MQS).ready(function() {
			...
			var qParams1Messages = new Array(
				...
				'The Lodz ghetto was the second largest ghetto established by the Nazis.  People in the Lodz ghetto were forced to act as a massive slave labor force.  The economic value of the work they produced in the ghetto ensured that it was the last ghetto in Poland to be destroyed, in August 1944.<br><br><a class="next-question" href="'+$legacyURL+'?name=pawel&question=2">Next question</a>'
			);
			var qParamsNextLink = '';
			var qParams1 = {
				mqID: 1,
